...
public class ViewchainFactory {
    ...
    public void addLayerToViewchainMain(ImageInfoView newLayer, View attachToViewchain) {
        ...
        synchronized (layeredView) {
            ...
            while (newLayer.getAdapter(SubimageDataView.class).getSubimageData(true) == null) {
                try {
                    Thread.sleep(100);
     ...
     *         new chain.
     */
    private ComponentView createNewViewchainMain() {
        // Layered View
     ...
     *         new chain.
     */
    private ComponentView createNewViewchainOverview(ComponentView mainImagePanelView) {
     ...
     */
    private ComponentView createViewchainFromExistingViewchain(ComponentView sourceImagePanelView, ComponentView mainImagePanelView, boolean keepSource) {
     ...
     */
    private void createViewchainFromExistingViewchain(View sourceView, View targetView, ComponentView mainImagePanelView, boolean keepSource) {
