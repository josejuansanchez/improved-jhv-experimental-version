...
//            TODO UNFINISHED: use all FITS meta data to calculate correct position
//            double crpix1 = metaDataContainer.tryGetDouble("CRPIX1");
//            double crpix2 = metaDataContainer.tryGetDouble("CRPIX2");
//
//            double crval1 = metaDataContainer.tryGetDouble("CRVAL1");
//            double crval2 = metaDataContainer.tryGetDouble("CRVAL2");
//
//            double cdelt1 = metaDataContainer.tryGetDouble("CDELT1");
//            double cdelt2 = metaDataContainer.tryGetDouble("CDELT2");
//
//            double sunX = crpix1 - crval1 / cdelt1;
//            double sunY = crpix2 - crval2 / cdelt2;
